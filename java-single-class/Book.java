...
public class Book {
    ...
    public static void main(String[] args) {
        ...
        // This will break code if main is in a different class (i.e. Main.main()) book1.title = "where is waldo";
        book1.setTitle("OOP Concepts");
        book1.setAuthor("Alice Brown");
        book1.setPrice(19.99); // this is subject to policy
        // book1.price = -5.00; // this is not agreeable ever because we always want to get money, not give money! we are making sales
